...
│   ├── SecurityFilterConfig.java       # 보안 필터 설정
...
│   └── common/
│       └── BaseEntity.java             # 공통 엔티티 (생성/수정 시간 등)
├── security/                           # JWT 인증/인가
...
│   ├── controller/                     # 옷장 API
│   ├── dto/                            # 옷장 DTO
│   ├── entity/                         # Cloth, Category 등
│   ├── repository/                     # ClothRepository
│   └── service/                        # 옷장 서비스
├── presets/                            # 코디 프리셋 도메인
│   ├── controller/                     # 프리셋 API
│   ├── dto/                            # 프리셋 요청/응답 DTO
│   ├── entity/                         # Preset 관련 엔티티
│   ├── repository/                     # PresetRepository
│   └── service/                        # 프리셋 서비스
├── wears/                              # 착용 기록 도메인
│   ├── controller/                     # 착용 API / 추천 API
│   ├── dto/                            # 착용 DTO
│   ├── entity/                         # Wear, WearItem
